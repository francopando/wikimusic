...
-- Reverts 20260906004900_rewrite_elvis_cabrera_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Elvis Cabrera is a Dominican artist whose work is associated with Merengue and Tropical. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
