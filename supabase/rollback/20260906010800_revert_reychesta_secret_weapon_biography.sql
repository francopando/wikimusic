...
-- Reverts 20260906010800_rewrite_reychesta_secret_weapon_biography.sql.
--
...
UPDATE artists SET
       ...
       stage_name = NULL,
       aliases = ARRAY['Reychesta Secret Weapon', 'Rey Chester']::text[],
       ...
       disambiguation = NULL,
       bio_en = 'Reychesta Secret Weapon is a Dominican artist. Born in 1978 in Santo Domingo, the artist reflects one of the many voices shaping Dominican music culture.',
       bio_es = NULL,
       updated_at = now()
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Reychesta Secret Weapon is a Dominican artist. Born in 1978 in Santo Domingo, the artist reflects one of the many voices shaping Dominican music culture.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'reychesta-secret-weapon'), 1)
