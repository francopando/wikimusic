...
-- Reverts 20260905343700_rewrite_griselda_soriano_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = NULL,
       disambiguation = NULL,
       bio_en = 'Griselda Soriano is a Dominican artist whose work is associated with Merengue and Tropical. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
