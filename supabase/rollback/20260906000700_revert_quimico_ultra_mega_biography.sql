...
-- Reverts 20260906000700_rewrite_quimico_ultra_mega_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Químico Ultra Mega is a Dominican artist. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
