...
-- Reverts 20260906005700_rewrite_karlos_rose_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Karlos Rosé is a Dominican artist whose work is associated with Bachata, Urban, and Tropical. The artist is connected to the Dominican Republic, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
