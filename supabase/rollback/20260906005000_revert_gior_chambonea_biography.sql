...
-- Reverts 20260906005000_rewrite_gior_chambonea_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Gior Chambonea is a Dominican artist whose work is associated with Dembow and Urban. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
