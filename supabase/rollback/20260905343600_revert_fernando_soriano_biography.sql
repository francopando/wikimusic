...
-- Reverts 20260905343600_rewrite_fernando_soriano_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = NULL,
       disambiguation = NULL,
       bio_en = 'Fernando Soriano is a Dominican artist whose work is associated with Balada, Bachata, and Tropical. The artist is connected to Santiago, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Fernando Soriano is a Dominican artist whose work is associated with Balada, Bachata, and Tropical. The artist is connected to Santiago, with work tied to Dominican music culture and its wider audience.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'fernando-soriano'), 1)
