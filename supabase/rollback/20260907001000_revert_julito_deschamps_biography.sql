...
-- Reverts 20260907001000_rewrite_julito_deschamps_biography.sql.
--
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Julito Deschamps was a Dominican singer associated with bolero, romantic song, and the urban bohemian tradition of mid‑20th‑century Dominican music. His career developed primarily in nightclubs and boites in Santo Domingo and Santiago, where he became a representative figure of intimate bolero performance. His recordings circulated in the Dominican Republic and among Caribbean and Latin communities abroad, establishing him as a distinctive voice within Dominican romantic music.","type":"text"}]},{"type":"paragraph","content":[{"text":"Early Life and Background","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Public records do not document Julito Deschamps’ date of birth or early musical formation. His emergence in the Dominican musical scene is situated in the early 1950s, a period marked by the growth of orchestras, dance halls, and small urban venues that shaped the country’s nightlife and bolero culture.","type":"text"}]},{"type":"paragraph","content":[{"text":"Professional Beginnings","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Deschamps began his professional career as a singer with the Papatín Ovalles Orchestra in 1952, entering the circuit of dance orchestras active in Santo Domingo. His earliest known recording is the bolero “Tu palabra y la mía”, composed by Antonio Morel and released in 1960. This recording marked the beginning of a repertoire that he would continue to interpret throughout his career.","type":"text"}]},{"type":"paragraph","content":[{"text":"Artistic Development","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Nightclubs and Boites","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Most of Deschamps’ artistic activity took place in boites and nightclubs, venues characterized by small audiences and close‑range performances. These spaces were central to the dissemination of bolero in the Dominican Republic during the mid‑20th century, and they provided the setting in which Deschamps developed his interpretive style and built his reputation.","type":"text"}]},{"type":"paragraph","content":[{"text":"Repertoire","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"His repertoire included works by Dominican and Latin American composers, among them:","type":"text"}]},{"type":"bulletList","content":[{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Será muy fácil","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Llorará por mí","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Dos palabras","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Negra soledad","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Poquita fe","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Háblame","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Olvídate de mí","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Torpeza","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Cosas del alma","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Tú, mi delirio","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Como duele una traición","type":"text"}]}]}]},{"type":"paragraph","content":[{"text":"He also performed widely recognized boleros from the broader Latin American tradition, including Sortilegio, La gloria eres tú, Evocación, Delirio, ¿Cómo fue?, Miénteme, Tres palabras, Pecadora, Te necesito, Yo vivo mi vida, and Amor perdido.","type":"text"}]},{"type":"paragraph","content":[{"text":"Collaborations","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Several of his studio recordings featured the saxophonist Andrés De Jesús, whose participation contributed to the characteristic sound of Deschamps’ recorded work.","type":"text"}]},{"type":"paragraph","content":[{"text":"Media Presence","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Unlike other performers of his era, Deschamps maintained limited media exposure. His career centered on live performance and studio recording, with minimal participation in television or large‑scale promotional circuits.","type":"text"}]},{"type":"paragraph","content":[{"text":"Musical Style","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Julito Deschamps’ work is situated within the bolero and romantic song tradition performed in urban Dominican settings between the 1950s and 1970s. His musical approach was characterized by:","type":"text"}]},{"type":"bulletList","content":[{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"emphasis on vocal clarity,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"selection of repertoire rooted in the Latin American bolero canon,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"accompaniment typically based on small ensembles,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"and performance contexts oriented toward intimate audiences rather than mass‑market stages.","type":"text"}]}]}]},{"type":"paragraph","content":[{"text":"His presence in boites and nightclubs positioned him within the Dominican bolero movement that flourished in mid‑century urban nightlife.","type":"text"}]},{"type":"paragraph","content":[{"text":"Death","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Julito Deschamps died on 13 November 1985 in Santo Domingo. His recordings continue to circulate among collectors, radio archives, and digital platforms, preserving his role in the development of Dominican bolero.","type":"text"}]},{"type":"paragraph","content":[{"text":"Legacy","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Julito Deschamps is regarded as a representative figure of Dominican bolero performed in small urban venues during the mid‑20th century. His repertoire, his sustained activity in boites, and his contribution to the diffusion of romantic song in the Dominican Republic place him within the historical framework of the country’s bolero tradition. Although documentation about his life is limited, surviving recordings and references in musical chronicles allow for his inclusion among notable contributors to Dominican romantic music.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'julito-deschamps'), 2)
...
INSERT INTO editorial_documents
  (document_type, locale, schema_version, document, status, owner_artist_id, revision)
VALUES ('artist_biography', 'es', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Julito Deschamps fue un cantante dominicano asociado al bolero, la balada y la tradición bohemia urbana de mediados del siglo XX. Su carrera se desarrolló principalmente en boites y clubes nocturnos de la República Dominicana, donde se convirtió en una figura representativa del repertorio romántico interpretado en espacios íntimos. Su obra circuló en el país y en comunidades caribeñas y latinas en el extranjero, consolidándose como una voz distintiva dentro del bolero dominicano.","type":"text"}]},{"type":"paragraph","content":[{"text":"Primeros años y formación","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Los datos sobre los primeros años de Julito Deschamps son escasos y no existen registros públicos que documenten su fecha de nacimiento o formación musical inicial. Su aparición en la escena artística dominicana se sitúa a comienzos de la década de 1950, en un momento en que las orquestas bailables y los clubes nocturnos comenzaban a consolidarse como espacios centrales de la vida musical urbana.","type":"text"}]},{"type":"paragraph","content":[{"text":"Inicios profesionales","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Deschamps inició su trayectoria profesional como cantante en la orquesta de Papatín Ovalles en 1952, integrándose al circuito de agrupaciones que animaban salones y clubes de Santo Domingo. Su primera grabación conocida corresponde al bolero “Tu palabra y la mía”, de Antonio Morel, registrada en 1960. A partir de esta etapa comenzó a construir un repertorio que lo acompañaría durante toda su carrera.","type":"text"}]},{"type":"paragraph","content":[{"text":"Desarrollo artístico","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Boites y clubes nocturnos","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"La mayor parte de la actividad artística de Deschamps se desarrolló en boites y clubes nocturnos de Santo Domingo y Santiago. Estos espacios, caracterizados por audiencias reducidas y presentaciones de formato íntimo, fueron el escenario principal donde interpretó boleros y canciones románticas que posteriormente se asociaron a su nombre.","type":"text"}]},{"type":"paragraph","content":[{"text":"Repertorio","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Su repertorio incluyó composiciones de autores dominicanos y latinoamericanos, entre ellas:","type":"text"}]},{"type":"bulletList","content":[{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Será muy fácil","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Llorará por mí","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Dos palabras","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Negra soledad","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Poquita fe","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Háblame","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Olvídate de mí","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Torpeza","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Cosas del alma","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Tú, mi delirio","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"Como duele una traición","type":"text"}]}]}]},{"type":"paragraph","content":[{"text":"También interpretó obras ampliamente difundidas en el bolero tradicional, como Sortilegio, La gloria eres tú, Evocación, Delirio, ¿Cómo fue?, Miénteme, Tres palabras, Pecadora, Te necesito, Yo vivo mi vida y Amor perdido.","type":"text"}]},{"type":"paragraph","content":[{"text":"Colaboraciones","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"En varias de sus grabaciones fue acompañado por el saxofonista Andrés De Jesús, cuya participación contribuyó a definir la sonoridad característica de sus interpretaciones en estudio.","type":"text"}]},{"type":"paragraph","content":[{"text":"Relación con los medios","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"A diferencia de otros intérpretes de su época, Deschamps mantuvo una presencia pública limitada. Su actividad se concentró en presentaciones en vivo y grabaciones, sin participación frecuente en televisión ni en circuitos mediáticos de mayor alcance.","type":"text"}]},{"type":"paragraph","content":[{"text":"Estilo musical","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"El estilo de Julito Deschamps se enmarca dentro del bolero y la canción romántica interpretada en contextos urbanos de mediados del siglo XX. Su enfoque se caracterizó por:","type":"text"}]},{"type":"bulletList","content":[{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"interpretación centrada en la claridad vocal,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"repertorio seleccionado dentro de la tradición del bolero latinoamericano,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"acompañamiento instrumental reducido,","type":"text"}]}]},{"type":"listItem","content":[{"type":"paragraph","content":[{"text":"y presentaciones en espacios íntimos más que en escenarios masivos.","type":"text"}]}]}]},{"type":"paragraph","content":[{"text":"Su figura se asocia al desarrollo del bolero en la República Dominicana durante la transición entre las décadas de 1950 y 1970, periodo en el que los clubes nocturnos desempeñaron un papel importante en la difusión de este género.","type":"text"}]},{"type":"paragraph","content":[{"text":"Fallecimiento","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Julito Deschamps falleció el 13 de noviembre de 1985 en Santo Domingo. Su obra continúa presente en colecciones de melómanos y en grabaciones que circulan en medios digitales y archivos privados, manteniendo su relevancia dentro de la historia del bolero dominicano.","type":"text"}]},{"type":"paragraph","content":[{"text":"Legado","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Julito Deschamps es considerado una figura representativa del bolero interpretado en espacios urbanos de la República Dominicana. Su repertorio, su presencia en boites y su contribución a la difusión del bolero en el país lo sitúan como un referente dentro de la tradición romántica dominicana de mediados del siglo XX. Aunque su vida y obra no están ampliamente documentadas, las grabaciones disponibles y las referencias en crónicas musicales permiten situarlo como parte importante del desarrollo del bolero en el ámbito local.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'julito-deschamps'), 2)
ON CONFLICT (document_type, owner_artist_id, locale)
  WHERE document_type = 'artist_biography'
DO UPDATE SET
  document = EXCLUDED.document,
