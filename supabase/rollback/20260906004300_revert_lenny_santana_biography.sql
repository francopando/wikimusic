...
-- Reverts 20260906004300_rewrite_lenny_santana_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Lenny Santana is a Dominican artist whose work is associated with Pop, Romantic, and Tropical. The artist is connected to the Dominican Republic, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
