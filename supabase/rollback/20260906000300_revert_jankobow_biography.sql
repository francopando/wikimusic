...
-- Reverts 20260906000300_rewrite_jankobow_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = 'jankobow',
       disambiguation = NULL,
       bio_en = 'Jankobow is a Dominican artist whose work is associated with Dembow and Urban. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
 WHERE slug = 'jankobow';
