...
-- Reverts 20260906001400_rewrite_puyalo_pantera_biography.sql.
--
...
It charted internationally and it was nominated for Best Dembow Song at the Premio Lo Nuestro of 2026, in a category that also held Celos by Ceky Viciny’s contemporaries — Tokischa with Bulin 47 — and Dem Bow by Natti Natasha with Nando Boom.
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'puyalo-pantera') AND locale = 'en'), '1b3302f7-0d3d-41dc-8286-e59d5584d097', 'artist', '550df3b5-6488-4aec-a476-a5d28d52ceea');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'puyalo-pantera') AND locale = 'en'), '77b0e4be-2425-42a7-b7da-b5f10c5e5817', 'artist', '741eb4c0-4ab8-4ad5-8a64-2f156da6a395');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'puyalo-pantera') AND locale = 'en'), 'fe863b20-0aa3-4425-aeb8-0c844572bca2', 'artist', '741eb4c0-4ab8-4ad5-8a64-2f156da6a395');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'puyalo-pantera') AND locale = 'es'), '540a421b-bc17-45df-881c-a3a533f9169a', 'artist', '741eb4c0-4ab8-4ad5-8a64-2f156da6a395');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'puyalo-pantera') AND locale = 'es'), '91489714-0b12-4af2-b8fb-bc63dd2d9c8d', 'artist', '550df3b5-6488-4aec-a476-a5d28d52ceea');
