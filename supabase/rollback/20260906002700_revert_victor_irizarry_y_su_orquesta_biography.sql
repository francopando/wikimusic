...
-- Reverts 20260906002700_rewrite_victor_irizarry_y_su_orquesta_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = NULL,
       disambiguation = NULL,
       bio_en = 'Víctor Irizarry is a Dominican artist. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Víctor Irizarry is a Dominican artist. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'victor-irizarry-y-su-orquesta'), 1)
