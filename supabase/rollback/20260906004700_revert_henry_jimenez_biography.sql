...
-- Reverts 20260906004700_rewrite_henry_jimenez_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Henry Jiménez is a Dominican artist whose work is associated with Merengue and Tropical. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
