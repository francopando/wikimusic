...
-- Reverts 20260906004200_rewrite_lolo_en_el_microfono_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'Lolo en el Micrófono is a Dominican artist whose work is associated with Dembow and Urban. The artist is connected to the Dominican Republic, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
