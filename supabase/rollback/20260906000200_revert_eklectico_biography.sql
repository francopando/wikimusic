...
-- Reverts 20260906000200_rewrite_eklectico_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = 'eklectico',
       disambiguation = NULL,
       bio_en = 'Eklectico is a Dominican artist whose work is associated with Urban, Dembow, and Alternative. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Eklectico is a Dominican artist whose work is associated with Urban, Dembow, and Alternative. The artist is connected to Santo Domingo, with work tied to Dominican music culture and its wider audience.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'eklectico'), 1)
