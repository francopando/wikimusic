...
-- Reverts 20260905341900_rewrite_luis_pimentel_biography.sql.
--
...
UPDATE artists SET
       ...
       instagram = NULL,
       disambiguation = NULL,
       bio_en = 'Luís Pimentel is a Dominican artist whose work is associated with Merengue, Traditional, and Tropical. The artist is connected to the Dominican Republic, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
