...
-- Reverts 20260906005100_rewrite_king_streetz_biography.sql.
--
...
UPDATE artists SET
       ...
       disambiguation = NULL,
       bio_en = 'King Streetz is a Dominican artist whose work is associated with Hip-Hop and Urban. The artist is connected to the Dominican Republic, with work tied to Dominican music culture and its wider audience.',
       bio_es = NULL,
       updated_at = now()
