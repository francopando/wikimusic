...
--
-- Peter Cruz. Rewrite. The old entry was machine-written, had no section titles,
-- no occupations, no instruments and no aliases, and carried a heading called
-- "Later Years and Health" -- a whole section pointed at material this catalogue
-- keeps out. That section is gone and nothing has replaced it.
--
-- THE SOURCE THAT MADE THIS WORTH REWRITING IS TWO DAYS OLD. Junior Cabrera's
-- "10 Preguntas" published an interview with him this week, and its own summary
-- lists what he talks about: the beginnings in Yamasá, the years with Cheche
-- Abreu, Aníbal Bravo and Wilfrido Vargas, the founding of the Orquesta
-- Internacional alongside Ramón Orlando and Carlos Herrera, how he found Cometa
-- Blanca on a cassette by the Spanish singer Chiquetete, the mambo he decided to
-- change in that arrangement himself, the unkept promise that made him leave the
-- Internacional at his peak, Fénix Ortiz's voice on his records, and why
-- Wilfrido Vargas never mentions him.
--
-- EVERYTHING IN THAT LIST IS HIS OWN ACCOUNT AND IS WRITTEN AS SUCH. The two
-- claims that touch other named people -- the unkept promise and Wilfrido
-- Vargas's silence -- are attributed to him in the prose, not stated as fact.
--
-- WHAT IS DELIBERATELY LEFT OUT. The same interview covers health crises he kept
-- private for years, and a separate interview from six months ago is billed as
-- him contradicting Ramón Orlando. Health is outside what this record keeps. The
-- Ramón Orlando material is not used because nothing found establishes what it is
-- ABOUT -- a credits dispute would belong here and a personal falling-out would
-- not, and a headline that says "desmiente" does not distinguish them.
--
-- COMETA BLANCA IS THE STORY. He says he found the song on a Chiquetete cassette
-- and brought it in. Chiquetete was a Spanish flamenco and copla singer, which is
-- about as far from a Dominican dance orchestra as a source gets, and the song
-- became one of the merengues of that decade. He also says the mambo -- the
-- horn break -- was his own change to the arrangement. That is an arrangement
-- credit claimed forty years after the fact by the man who sang it, and this
-- catalogue records authorship, so it is here, attributed.
--
-- FILLED: sort_name and stage_name, both null; aliases stays empty because
-- nothing is attested; occupations vocalist -- he is described as a singer AND a
-- corista, and the backing-vocal work is a real part of what he did; genres;
-- instruments; the legend tag; disambiguation. last_name is normalised from "de
-- La Cruz" to "de la Cruz".
--
-- LEFT ALONE: province Monte Plata and birth_place Yamasá, which his own
-- interview confirms. date_of_birth 1960-05-27 is left exactly as stored and is
-- NOT verified -- nothing found gives a birth date at all.
--
-- SOURCES: Junior Cabrera's "10 Preguntas", published two days before this entry
-- was written, and its summary. La Radio Estación's posting of the 1984 single
-- Ron Pa To El Mundo, credited to Peter Cruz with Wilfrido Vargas's orchestra.
-- Noche Fenomenal and Jorge Gómez for the 1986 album Peter Cruz y su Banda after
-- his exit from the Internacional. Los Clásicos RD for the record billed to
-- Wilfrido Vargas with Rubby Pérez, Peter Cruz and Junior Castillo. Manolo Ozuna
-- DG's interview of six months ago, used only as evidence that he is active.
--
-- NOT LINKED: Chiquetete is Spanish. Carlos Herrera, with whom he says he founded
-- the Orquesta Internacional, and Junior Castillo have no entries. Carlos Herrera
-- is the notable gap.
--
...
That is an arranging credit claimed forty years later by the man who sang it. The singer usually gets the applause and never the credit, and a singer who finally asks for the credit is doing something the trade rarely allows.
...
Es un crédito de arreglo reclamado cuarenta años después por el que lo cantó. Al cantante le suelen dar los aplausos y nunca el crédito, y un cantante que por fin lo reclama está haciendo algo que el oficio rara vez permite.
...
VALUES ('artist_biography', 'en', 1, '{"type":"doc","content":[{"type":"paragraph","content":[{"text":"Peter Cruz, born Pedro Antonio de la Cruz in Yamasá, is a Dominican merengue singer. He was inside three of the most important bands of the nineteen-eighties and he is one of the founders of a fourth, and for most of that time his name was the smallest thing on the sleeve.","type":"text"}]},{"type":"paragraph","content":[{"text":"Coming up through the bands","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Yamasá is a town in Monte Plata, inland and unglamorous, and he left it for the orchestras. He sang with ","type":"text"},{"type":"artistReference","attrs":{"artistId":"73691e65-206a-4c71-9b5f-8689f15b2584","displayText":"Cheche Abreu","occurrenceId":"c4dcb614-98cd-4fe6-b95b-6544b45e558d"}},{"text":" and with ","type":"text"},{"type":"artistReference","attrs":{"artistId":"f050869b-f4c0-4281-b883-bce0120ad9b2","displayText":"Aníbal Bravo","occurrenceId":"c69347c7-b0c0-4d4c-9f63-918aef4e587f"}},{"text":" before the job that made him, which was with ","type":"text"},{"type":"artistReference","attrs":{"artistId":"2bc36959-dcce-4e10-9ecf-2cd418eaa489","displayText":"Wilfrido Vargas","occurrenceId":"5280248a-19b6-4920-886f-811bfa0e1cd8"}},{"text":".","type":"text"}]},{"type":"paragraph","content":[{"text":"Ron Pa To El Mundo, from 1984, is billed to Peter Cruz with Wilfrido Vargas’s orchestra. Being the voice on a Wilfrido record in that decade meant being heard across the whole Caribbean, and it also meant being interchangeable: the band was the name, the singer was staff.","type":"text"}]},{"type":"paragraph","content":[{"text":"He has said publicly that Wilfrido Vargas never mentions him in interviews. Whether that is an oversight or something else, the omission is real enough that he has been asked about it on camera, and it is a fair description of what happens to a singer who was hired rather than billed.","type":"text"}]},{"type":"paragraph","content":[{"text":"Founding the Internacional","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"He tells it that he founded the Orquesta Internacional together with ","type":"text"},{"type":"artistReference","attrs":{"artistId":"02f23257-1cf6-4a4c-8df1-1f9aa630a2c3","displayText":"Ramón Orlando","occurrenceId":"c6c87b9a-e90b-47ac-abad-cfda30cc2e69"}},{"text":" and Carlos Herrera. The band went on to be one of the defining merengue orchestras of its era and it carries Ramón Orlando’s name to this day.","type":"text"}]},{"type":"paragraph","content":[{"text":"He left it at the top, and his account of why is a promise that was not kept. He does not say more than that in public, and the detail stays where he left it.","type":"text"}]},{"type":"paragraph","content":[{"text":"Cometa Blanca","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"Cometa Blanca is the record he is attached to, and his account of where it came from is the best thing in his story: he found it on a cassette by Chiquetete, a Spanish flamenco and copla singer, and brought it to the band.","type":"text"}]},{"type":"paragraph","content":[{"text":"A merengue orchestra taking a song off an Andalusian record is not an odd thing in itself — Dominican bands have always eaten whatever was in the room — but it takes somebody actually listening to hear a merengue inside a copla. He also says the mambo, the horn break that lifts the song, was a change he made to the arrangement himself.","type":"text"}]},{"type":"paragraph","content":[{"text":"That is an arranging credit claimed forty years later by the man who sang it. The singer usually gets the applause and never the credit, and a singer who finally asks for the credit is doing something the trade rarely allows.","type":"text"}]},{"type":"paragraph","content":[{"text":"On his own","type":"text","marks":[{"type":"bold"}]}]},{"type":"paragraph","content":[{"text":"After the Internacional he put out Peter Cruz y su Banda in 1986 and went on working. ","type":"text"},{"type":"artistReference","attrs":{"artistId":"04fde466-8488-43b4-ab52-e07d12791141","displayText":"Fénix Ortiz","occurrenceId":"de5693dd-2cdd-4a62-897c-1f5cf589ad8f"}},{"text":" sang on his records. He has since turned up on a Wilfrido Vargas record alongside ","type":"text"},{"type":"artistReference","attrs":{"artistId":"cff70c92-8632-4c66-b5a0-81622c8128b0","displayText":"Rubby Pérez","occurrenceId":"258012ee-5290-4038-a79f-e60101627a4b"}},{"text":" and Junior Castillo — three voices from three different bands of the same decade, on one track.","type":"text"}]},{"type":"paragraph","content":[{"text":"He still gives interviews, at length, and the interest in them is not nostalgia. He is one of the few people left who can say what actually happened inside those orchestras, and he is willing to say it.","type":"text"}]}]}'::jsonb, 'published', (SELECT id FROM artists WHERE slug = 'peter-cruz'), 5)
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), '258012ee-5290-4038-a79f-e60101627a4b', 'artist', 'cff70c92-8632-4c66-b5a0-81622c8128b0');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), '5280248a-19b6-4920-886f-811bfa0e1cd8', 'artist', '2bc36959-dcce-4e10-9ecf-2cd418eaa489');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), 'c4dcb614-98cd-4fe6-b95b-6544b45e558d', 'artist', '73691e65-206a-4c71-9b5f-8689f15b2584');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), 'c69347c7-b0c0-4d4c-9f63-918aef4e587f', 'artist', 'f050869b-f4c0-4281-b883-bce0120ad9b2');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), 'c6c87b9a-e90b-47ac-abad-cfda30cc2e69', 'artist', '02f23257-1cf6-4a4c-8df1-1f9aa630a2c3');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'en'), 'de5693dd-2cdd-4a62-897c-1f5cf589ad8f', 'artist', '04fde466-8488-43b4-ab52-e07d12791141');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), '319bc944-a9ff-42a8-9c56-eae5a445ea48', 'artist', '02f23257-1cf6-4a4c-8df1-1f9aa630a2c3');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), '38e8290e-732f-44a4-9d8d-1a73014029b5', 'artist', '04fde466-8488-43b4-ab52-e07d12791141');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), '44230d0a-8352-4b2f-a223-9df7d2f03c69', 'artist', '2bc36959-dcce-4e10-9ecf-2cd418eaa489');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), '59b1bb9c-46ec-4b73-86e4-2928f8f58b9d', 'artist', 'f050869b-f4c0-4281-b883-bce0120ad9b2');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), 'a0d79fdf-3d40-4fb0-bf5e-d247a60fb839', 'artist', 'cff70c92-8632-4c66-b5a0-81622c8128b0');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'peter-cruz') AND locale = 'es'), 'e27e073e-4dae-4d95-ab92-2d86db517d40', 'artist', '73691e65-206a-4c71-9b5f-8689f15b2584');
