...
--
-- NOT LINKED: Suming is Taiwanese. Cristino Gómez is Dominican and has no entry
-- -- he is a poet rather than a musician, but he wrote the lyrics of an entire
-- EP, which is a lyricist credit and the kind of authorship this catalogue
-- records. He is going on the missing-artists list.
--
