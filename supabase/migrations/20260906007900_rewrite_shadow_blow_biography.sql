...
-- nothing else.
--
-- "MICHAEL FLORES": THE ANSWER, AND A CORRECTION TO HOW THE FIRST VERSION OF
-- THIS NOTE REASONED. The name, credited on Me Tocó Brillar in 2025, matches
-- Monkey Black in the catalogue, whose legal name is Leonardo Michael Flores
-- Ozuna. The first version of this note dismissed the match by saying Monkey
-- Black died in 2014 and therefore could not be on a 2025 record.
--
-- That reasoning is wrong and should not be repeated. A release carries credits
-- of several kinds -- performance, composition, arrangement, production,
-- sampling -- and only the release date belongs to the year on the label. A
-- verse cut years earlier, a song written before the writer died, a sampled
-- phrase or a posthumous issue all put a dead artist on a new record, and
-- Dominican urban music does all four routinely. A death date rules out
-- nothing on its own; what rules something in or out is knowing WHICH credit
-- it is.
--
-- So the credit was checked instead of assumed. Me Tocó Brillar was released on
-- 23 November 2025 and billed JLEXIS X MICHAEL FLORES X SHADOW BLOW X ALOFOKE
-- MUSIC, which in this genre is a performing credit. Michael Flores is a living
-- Puerto Rican -- Viberate files him as a musician from Puerto Rico, Ozuna
-- addressed him and JLexis publicly as the Puerto Rican contestants in the
-- second season of La Casa de Alofoke, and both of them are reported to have
-- started singing only after entering that house in October 2025.
--
-- He is therefore not Monkey Black, and he is also not eligible for this
-- catalogue, which is the reason he is not linked. The right reason, not the
-- first one.
--
-- NOT LINKED: Bryant Myers, Nío García, Brray, JLexis and Michael Flores are
-- Puerto Rican. Bulova, Liro Shaq El Sofoke and La Fruta are Dominican and have
-- no entries.
--
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '2383152d-e205-4fd8-8c6c-dfc0f577cd47', 'artist', '439bbc6c-f06e-447f-a1fa-b2130b885457');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '2f25535d-f5e6-40d3-b445-1a96ed948ff3', 'artist', '741eb4c0-4ab8-4ad5-8a64-2f156da6a395');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '3245b43d-e3c5-41d0-8e4a-afb249d7da7f', 'artist', 'fa9cc802-28ca-4695-b585-f75aa90a2b6c');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '33a986ae-f77d-4593-82d4-33a756067a1a', 'artist', '6321da6c-e2d5-490a-a4e8-416bbee81edf');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '4fc38589-6008-44cd-a727-7fc6cf2666cf', 'artist', 'd08f2c85-7f47-449e-a486-a19ba3b5841a');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), '557a3e84-7396-4f0a-8bf5-edc144023cd6', 'artist', '95e181f1-58e5-4537-a5e8-75a9f60c6aca');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), 'b99eb484-ecce-446f-ae58-555dffa34931', 'artist', '97610f30-fb92-4d77-8b98-ddec14d12afc');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'en'), 'e7e5707c-9e42-4ce0-a0f7-0086d11ee8cc', 'artist', '102e7b78-ff98-4adc-9a54-ae73791fb176');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), '1afbe7e3-ec88-4857-b61e-d4e9684399b6', 'artist', '6321da6c-e2d5-490a-a4e8-416bbee81edf');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), '1e84a338-1c01-4292-8acb-25472ba33087', 'artist', '102e7b78-ff98-4adc-9a54-ae73791fb176');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), '50d7d043-2169-4c65-8353-7f7cf8404e51', 'artist', 'fa9cc802-28ca-4695-b585-f75aa90a2b6c');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), '6d972165-63aa-4a4f-8bc6-cae1617f6b31', 'artist', 'd08f2c85-7f47-449e-a486-a19ba3b5841a');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), '70404321-9f5e-4c94-92fa-4bbdca8a7e58', 'artist', '741eb4c0-4ab8-4ad5-8a64-2f156da6a395');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), 'c8e61ba4-b60d-4c53-a6c6-4003782a1e50', 'artist', '439bbc6c-f06e-447f-a1fa-b2130b885457');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), 'ecb0d290-41b8-454f-badf-a06a73729539', 'artist', '97610f30-fb92-4d77-8b98-ddec14d12afc');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'shadow-blow') AND locale = 'es'), 'fff578f6-c5cd-4761-ab9f-e3c5964c9188', 'artist', '95e181f1-58e5-4537-a5e8-75a9f60c6aca');
