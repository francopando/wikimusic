...
--
-- "MELOSO" IS NOW LINKED, AND HERE IS WHAT CLOSED IT. The first version of this
-- entry named the credit on El Pichirry as "Meloso" and refused to link Yomel
-- el Meloso, because nothing found connected the two names. Writing Yomel's own
-- entry afterwards produced the connection: BuenaMusica's chronology records
-- that in 2019 he released "El Pichirri" with Kiko el Crazy and El Cherry Scom
-- -- same title, same two named collaborators, same year as the video billed
-- "Ito Ogamy x Kiko El Crazy x Meloso x Cherry Scom". It is one record. The
-- reference is added.
--
-- The refusal was right at the time and the fix is right now. An identity is
-- not guessed at; it is either established or it waits.
--
...
He has kept releasing. El Pionero states the position in a title. Dominican Legends was made with Alex X, Lápida with Radel Rap, and El Pichirry put him on the same record as Kiko el Crazy, Yomel el Meloso and El Cherry Scom — thirty years of Dominican rap on one track, which is not a common thing to arrange.
...
No ha dejado de publicar. El Pionero declara la posición en el título. Dominican Legends la hizo con Alex X, Lápida con Radel Rap, y El Pichirry lo puso en el mismo disco que Kiko el Crazy, Yomel el Meloso y El Cherry Scom; treinta años de rap dominicano en un solo tema, que no es una cosa corriente de armar.
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'en'), '197edcd0-80e0-4d8f-897d-48f12dbca029', 'artist', '102e7b78-ff98-4adc-9a54-ae73791fb176');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'en'), '39f8167c-9a24-45cd-bf0c-d35fc869fd6d', 'artist', 'bb07dcb8-444f-4a68-a668-21e9e038f335');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'en'), 'bf047ca8-69b5-4137-acb8-7737f14892d7', 'artist', '0b2e1a39-b265-42d6-95d5-85ad930eee84');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'en'), 'fc9c87c8-7558-44dd-8058-f0f8802304b2', 'artist', '9be0ed08-6eb6-4ca0-bb68-d5126190aeb1');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'es'), '2d902d56-a89d-468f-acdc-acd08b7d5258', 'artist', 'bb07dcb8-444f-4a68-a668-21e9e038f335');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'es'), '75c1b3b8-c86c-4f82-980d-256e10e6c810', 'artist', '9be0ed08-6eb6-4ca0-bb68-d5126190aeb1');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'es'), '7b1b8c82-5965-41fe-8748-59d7a9b8078a', 'artist', '102e7b78-ff98-4adc-9a54-ae73791fb176');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'ito-ogamy') AND locale = 'es'), 'db15c860-9b5b-4e7d-b794-f55271b29359', 'artist', '0b2e1a39-b265-42d6-95d5-85ad930eee84');
