...
-- accounts lead with.
--
-- LINKED: Prophex, who is in the catalogue and published.
--
-- NOT LINKED: Bachata Gang, which has an entry but is still needs_review and
-- would render as dead plain text on a published page, so it is named in prose.
-- DJ Tronky and DJ Manuel Citro have no entries; Tronky is Italian and should
-- not have one.
--
...
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'oscar-dominic') AND locale = 'en'), 'b97dde7c-11f3-4c1a-93ad-93094ca04ebe', 'artist', '278237f4-81ff-4770-8344-b81c1dc67ebe');

INSERT INTO editorial_entity_references
  (editorial_document_id, occurrence_id, entity_type, target_artist_id)
VALUES ((SELECT id FROM editorial_documents WHERE owner_artist_id = (SELECT id FROM artists WHERE slug = 'oscar-dominic') AND locale = 'es'), 'd6de1093-2ed5-4665-8136-8efd60f347c5', 'artist', '278237f4-81ff-4770-8344-b81c1dc67ebe');
