...
-- twenty-four minutes, closing on Ya No Estas, a rock song that breaks with the
-- rest, and it names Yuna, Green Hills and the Saria's Song interlude.
-- MusicBrainz for the 2024 album ##PaKBaileJerk2K24 ##45*16, released 16
-- February 2024, and its tracks ##ADIOS, ##BEBO, ##BIPOLAR, ##CICLOS,
-- ##EMOCIONES, ##MANUEL ##MENUDO #16, CREO EN EL ##LEAN and MUSICA TRISTE. The
-- SONGMESS podcast, which played Tu no m kiere tu me necesitas. A joint release
-- with 1SANT, domi cinco, produced by 1SANT: Divareando, Eso e eso, Situteva,
-- #eltiempodepapa. An international listener round-up that carried Choco Crema
-- as the Dominican entry beside artists from Botswana, France, Argentina and
-- Japan. DISCOLAI again on 17 July 2026, still naming him among current
-- Dominican releases.
--
-- NOT WRITTEN: a birth date, and anything about the substances his song titles
-- name. Neither is documented and the second is not musical work.
--
-- NOT LINKED: UNDR, 1SANT, Ecstasy, Kino Rose and NicolK have no entries. UNDR
-- in particular is a collective several of whose members keep appearing in this
-- catalogue's gaps.
--
